...
RSpec.describe AnnotationsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      annotation = Annotation.create! valid_attributes
      get :show, params: {id: annotation.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new annotation" do
        ...
        expect(response.location).to eq(annotation_url(Annotation.last))
      end
    end
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the annotation" do
        ...
        put :update, params: {id: annotation.to_param, annotation: invalid_attributes}, session: valid_session
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq('application/json')
      end
    end
